  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      <div className="w-full md:w-1/2 h-64 md:h-full relative overflow-hidden">
        <img
          src="https://i.pinimg.com/originals/fe/45/95/fe45957a255442718f566ba9942384a8.png"
          alt="Potted cactus and snake plant in minimal pots against a pastel blue-grey wall"
      ...
      <div className="w-full md:w-1/2 h-full md:h-auto bg-white md:p-12 p-8 flex flex-col justify-center">
        {/* Back Button */}
        <button
          onClick={() => router.push('/')}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-4 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all"
              required
            />
          </div>
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-4 pr-12 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all"
              required
            />
            <button
              type="button"
          ...
          <div className="my-8">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-black text-white py-4 rounded-xl font-semibold text-lg hover:bg-gray-800 transition-all duration-200 disabled:opacity-50"
            >
